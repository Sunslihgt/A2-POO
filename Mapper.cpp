...
namespace NS_DB {
	...
	//System::String^ Mapper::selectClientDeliveryAddressesByIdClient(int idClient) {
	...
	//}
	//
	//System::String^ Mapper::selectClientBillingAddressesByIdClient(int idClient) {
	...
	System::String^ Mapper::updatePurchasedItem(int idPurchasedItem, int idItem, int itemAmount, float totalPrice, float vatAmount) {
		bool modification = false;
		bool ajout = false;
	...
	System::String^ Mapper::updatePurchase(int idPurchase, int idClient, int idPaymentMethod, System::DateTime^ purchaseDate, System::DateTime^ payDate, float discountAmount, float dutyFreePrice, float vatAmount, float ttcPrice) {
		bool modification = false;
		bool ajout = false;
	...
	//System::String^ Mapper::deleteAddressCity(int idAddressCity) {
